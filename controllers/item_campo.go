...
type ItemCampoController struct {
	beego.Controller
}

// URLMapping ...
func (c *ItemCampoController) URLMapping() {
...
// @Param	body		body 	models.ItemCampo	true		"body for ItemCampo content"
// @Success 201 {int} models.ItemCampo
// @Failure 403 body is empty
// @router / [post]
func (c *ItemCampoController) Post() {
	var v models.ItemCampo
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddItemCampo(&v); err == nil {
...
// @Success 200 {object} models.ItemCampo
// @Failure 403 :id is empty
// @router /:id [get]
func (c *ItemCampoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetItemCampoById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 403
// @router / [get]
func (c *ItemCampoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllItemCampo(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @router /:id [put]
func (c *ItemCampoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.ItemCampo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateItemCampoById(&v); err == nil {
...
// @Failure 403 id is empty
// @router /:id [delete]
func (c *ItemCampoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteItemCampo(id); err == nil {
