...
// @Success 201 {int} models.Seccion
...
func (c *SeccionController) Post() {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddSeccion(&v); err == nil {
...
func (c *SeccionController) GetOne() {
	...
	v, err := models.GetSeccionById(id)
	if err != nil {
		logs.Error(err)
...
func (c *SeccionController) GetAll() {
	...
	l, err := models.GetAllSeccion(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *SeccionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.Seccion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateSeccionById(&v); err == nil {
...
func (c *SeccionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteSeccion(id); err == nil {
